...
export const DIGITAL_PRODUCTS: PortfolioItem[] = [
  {
    ...
    badge: 'Best Seller',
    demoUrl: 'https://demo.web4go.com/ecommerce',
    isProduct: true,
    description: 'Website toko online siap pakai dengan sistem keranjang belanja, checkout instan WhatsApp & Payment Gateway, serta katalog produk responsif.',
    tags: ['E-Commerce', 'Payment Gateway', 'Katalog Produk', 'Notif WhatsApp'],
  },
  {
    id: 'company-profile',
    ...
    badge: 'Popular',
    demoUrl: 'https://demo.web4go.com/company-profile',
    isProduct: true,
    description: 'Template company profile elegan & berkelas untuk meningkatkan reputasi perusahaan, menampilkan profil tim, portofolio, dan layanan bisnis.',
    tags: ['Company Profile', 'Corporate', 'Multi-Halaman', 'SEO Ready'],
  },
  {
    ...
    badge: 'Trending',
    demoUrl: 'https://demo.web4go.com/portfolio',
    isProduct: true,
    description: 'Showcase portofolio visual interaktif untuk desainer, fotografer, dan agensi kreatif dengan animasi micro-interaction yang memukau.',
    tags: ['Portofolio', 'Dark Mode', 'Grid Showcase', 'Smooth Scroll'],
  },
  {
    id: 'saas-landing',
    name: 'SaaS / App Landing Page',
    category: 'Produk',
    year: '2026',
    price: 'Rp 229.000',
    originalPrice: 'Rp 549.000',
    badge: 'Hot',
    demoUrl: 'https://demo.web4go.com/saas',
    isProduct: true,
    description: 'Landing page konversi tinggi untuk startup, aplikasi mobile, dan produk digital SaaS lengkap dengan tabel pricing, FAQ, dan testimoni.',
    tags: ['SaaS Landing', 'Pricing Table', 'Feature Grid', 'High Conversion'],
  },
  {
    id: 'undangan-digital',
    ...
    badge: 'Favorit',
    demoUrl: 'https://demo.web4go.com/undangan',
    isProduct: true,
    description: 'Website undangan pernikahan & acara digital dengan fitur RSVP online, hitung mundur (countdown), galeri foto, peta lokasi, dan amplop digital.',
    tags: ['Undangan Digital', 'RSVP & Ucapan', 'Amplop Digital', 'Google Maps'],
  },
  {
    id: 'resto-menu',
    name: 'F&B / Menu Restoran',
    category: 'Produk',
    year: '2026',
    price: 'Rp 189.000',
    originalPrice: 'Rp 449.000',
    badge: 'New',
    demoUrl: 'https://demo.web4go.com/resto-menu',
    isProduct: true,
    description: 'Katalog menu digital interaktif scan QR code untuk cafe & resto, dilengkapi filter kategori makanan/minuman dan pemesanan via meja.',
    tags: ['Menu QR Code', 'F&B Catalog', 'Filter Kategori', 'Order WhatsApp'],
  },
  {
    id: 'kelas-online',
    name: 'Kelas Online / LMS',
    category: 'Produk',
    year: '2026',
    price: 'Rp 279.000',
    originalPrice: 'Rp 699.000',
    badge: 'Pro',
    demoUrl: 'https://demo.web4go.com/lms',
    isProduct: true,
    description: 'Platform kursus & materi edukasi online lengkap dengan preview modul video, silabus belajar terstruktur, dan halaman pendaftaran member.',
    tags: ['LMS Platform', 'Modul Video', 'Silabus Interaktif', 'Member Area'],
  },
  {
    id: 'listing-properti',
    ...
    badge: 'Featured',
    demoUrl: 'https://demo.web4go.com/properti',
    isProduct: true,
    description: 'Website katalog properti modern untuk agen & developer dengan filter harga, lokasi, tipe rumah, serta tombol kontak agen instan.',
    tags: ['Listing Properti', 'Filter Lokasi & Harga', 'Spesifikasi Unit', 'Direct WhatsApp'],
  },
  {
    id: 'link-in-bio',
    name: 'Link-in-Bio',
    ...
    badge: 'Lite',
    demoUrl: 'https://demo.web4go.com/biolink',
    isProduct: true,
    description: 'Halaman bio link ultra-cepat untuk creator & brand, menggabungkan semua link media sosial, jualan produk, dan portofolio dalam 1 halaman.',
    tags: ['Link-in-Bio', 'Social Hub', 'Mobile First', 'Ultra Fast'],
  },
  {
    id: 'portal-berita',
    name: 'Portal Berita',
    ...
    year: '2026',
    price: 'Rp 259.000',
    originalPrice: 'Rp 629.000',
    badge: 'Editorial',
    demoUrl: 'https://demo.web4go.com/berita',
    isProduct: true,
    description: 'Portal media berita & artikel online dengan layout majalah digital modern, breaking news ticker, slot iklan terintegrasi, dan kategori topik.',
    tags: ['Portal Berita', 'Magazine Grid', 'Breaking News', 'AdSense Ready'],
  },
  {
    id: 'directory-bisnis',
    name: 'Directory Bisnis',
    category: 'Produk',
    year: '2026',
    price: 'Rp 249.000',
    originalPrice: 'Rp 599.000',
    badge: 'Directory',
    demoUrl: 'https://demo.web4go.com/directory',
    isProduct: true,
    description: 'Website direktori listing bisnis lokal & ulasan layanan lengkap dengan pencarian kategori, maps interaktif, dan nomor kontak terverifikasi.',
    tags: ['Direktori Bisnis', 'Search & Filter', 'Rating & Review', 'Verified Badge'],
  },
];
